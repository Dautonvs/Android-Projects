...
public class MainActivity extends AppCompatActivity {
    ...
    SharedPreferences sp; //cria instancia do Shared Preference
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = getSharedPreferences("entrar", MODE_PRIVATE);

        //Cria objeto que vai checar a opção 'Conectado'
    ...
    //Método que abre a Activity DashBoard
    ...
    //Método que realizará a ação do botão Entrar
